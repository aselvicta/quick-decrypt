"""
Django settings for quickdecrypt project.
...
ROOT_URLCONF = 'quickdecrypt.urls'
...
WSGI_APPLICATION = 'quickdecrypt.wsgi.application'
...
SECURE_HSTS_PRELOAD = True  # Allow your site to be included in browsers' HSTS preload list
